...
//    }
    ...
    void givenMultipleEntity_whenFindAll_thenReturnEntityList(int expectedRecordCount) throws SystemException, NotSupportedException {
        ...
        try {
            ...
            fail("Failed to fetch entity with exception message %s", ex.getMessage());
        }
    }
